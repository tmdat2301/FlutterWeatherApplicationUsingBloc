...
import 'package:flutter_weather_application/detailPage.dart';
import 'package:flutter_weather_application/extraWeather.dart';
...
void initState() { 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 44, 121,193),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: GlowContainer(
        ...
        margin: EdgeInsets.only(top: 21,left: 20,right: 20),
